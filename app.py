...
def display_home(chapter_names):
    ...
    with col1:
        img_path = "attached_assets/chapter2/chapter2.jpg"
        if os.path.exists(img_path):
            st.image(img_path, use_container_width=True)
        else:
            st.markdown("🛠️ Working on it...")
    ...
    with col1:
        img_path = "attached_assets/chapter3/chapter3.jpg"
        if os.path.exists(img_path):
            st.image(img_path, use_container_width=True)
        else:
            st.markdown("🛠️ Working on it...")
    ...
    with col2:
        st.markdown(" ## Book 3 - Aranya-Kanda")
    with col3:
        st.markdown(
    ...
    with col1:
        img_path = "attached_assets/chapter4/chapter4.jpg"
        if os.path.exists(img_path):
            st.image(img_path, use_container_width=True)
        else:
            st.markdown("🛠️ Working on it...")
    ...
    with col2:
        st.markdown(" ## Book 4 - Kishkindha-kanda")
    with col3:
        st.markdown(
    ...
    with col1:
        img_path = "attached_assets/chapter5/chapter5.jpg"
        if os.path.exists(img_path):
            st.image(img_path, use_container_width=True)
        else:
            st.markdown("🛠️ Working on it...")
    ...
    with col2:
        st.markdown(" ## Book 5 - Sundara-kanda")
    with col3:
        st.markdown(
    ...
    with col1:
        img_path = "attached_assets/chapter7/chapter7.jpg"
        if os.path.exists(img_path):
            st.image(img_path, use_container_width=True)
        else:
            st.markdown("🛠️ Working on it...")
    ...
    with col2:
        st.markdown(" ## Book 7 - Uttara-kanda")
    with col3:
        st.markdown(
